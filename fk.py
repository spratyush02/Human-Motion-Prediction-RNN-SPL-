...
def sparse_to_full(joint_angles_sparse, sparse_joints_idxs, tot_nr_joints):
    """
...
def local_rot_to_global(joint_angles, parents, left_mult=False):
    """
...
class ForwardKinematics(object):
    ...
    def from_sparse(self, joint_angles_sparse, return_sparse=True):
        """
